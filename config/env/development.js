...
module.exports = {
  db: {
    uri: process.env.MONGOHQ_URL || process.env.MONGODB_URI || 'mongodb://' + (process.env.DB_1_PORT_27017_TCP_ADDR || 'localhost') + '/meet-up',
    options: {},
  ...
  stripe: {
    clientID: process.env.Stripe_ID || 'CLIENT_ID',
    clientSecret: process.env.Stripe_SECRET || 'CLIENT_SECRET',
    clientPublishableKey: process.env.Stripe_Publishable_Key || 'Publishable_Key',
